...
| Tier | Documents | Role |
|---|---|---|
| **Normative** | [`atd-architecture.md`](atd-architecture.md) · [`protocol/wire-format.md`](protocol/wire-format.md) · [`protocol/error-codes.md`](protocol/error-codes.md) · [`protocol/dry-run-contract.md`](protocol/dry-run-contract.md) · [`/atd-protocol-schema.json`](../atd-protocol-schema.json) | The protocol contract. Source of truth for behaviour and wire shape. |
...
| **Context** | [`atd-design-philosophy.md`](atd-design-philosophy.md) · [`atd-positioning.md`](atd-positioning.md) · [`roadmap.md`](roadmap.md) · [`adr/`](adr/) · [`issues/`](issues/) | Rationale, evolution scope, decisions, tracked gaps. |
...
| Goal | Read |
|---|---|
| Understand what ATD is and why | [`atd-positioning.md`](atd-positioning.md), then [`atd-architecture.md`](atd-architecture.md) §1–§2 |
...
| Know what is deferred / out of scope / coming later | [`roadmap.md`](roadmap.md) + [`atd-architecture.md`](atd-architecture.md) §10 |
...
| Path | Contents |
|---|---|
| [`atd-architecture.md`](atd-architecture.md) | The normative architecture — layers, dispatch, security, middleware, crate map, non-goals. |
...
1. [`atd-positioning.md`](atd-positioning.md) — what problem ATD solves.
2. [`atd-architecture.md`](atd-architecture.md) — how the system is built.
